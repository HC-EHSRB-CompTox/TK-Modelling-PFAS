...
tissues_all <- c( "C_total_plasma", "C_total_liver", "C_total_kidneys",  "C_total_gut", "C_total_rest")
pbtk <- tissue_long %>%
   filter(Compartment != "C_total_blood")  %>%
  mutate(
    Tissue = factor(
...
pbtk$Dose_Time <- paste0(pbtk$dose, " (", pbtk$day, ")")
...
plot_pfoa
ggsave(filename = "../plots/pfoa_fischer.png", plot = plot_pfoa, width = 12.5, height = 7.5, dpi = 300,bg = "white")
...
ggsave(filename = "../plots/pfos_fischer.png", plot = plot_pfos, width = 12.5, height = 7.5, dpi = 300,bg = "white")
